...
class FavoritesFragment : Fragment(), ItemListAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        val adapter = ItemListAdapter(this, viewLifecycleOwner, itemViewModel.allFavoriteItems, itemViewModel){ show -> showDeleteMenu(show) }
