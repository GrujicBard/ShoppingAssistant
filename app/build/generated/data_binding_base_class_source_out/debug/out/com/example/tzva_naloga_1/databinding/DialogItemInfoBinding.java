...
public final class DialogItemInfoBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton btnStockMinus;

  @NonNull
  public final ImageButton btnStockPlus;
  ...
  @NonNull
  public final TextView tvStockDg;

  private DialogItemInfoBinding(@NonNull LinearLayout rootView, @NonNull Button btnClose,
      @NonNull ImageButton btnFavoriteDg, @NonNull ImageButton btnShoppingDg,
      @NonNull ImageButton btnStockMinus, @NonNull ImageButton btnStockPlus,
      @NonNull ImageView ivPicDg, @NonNull TextView textView6, @NonNull TextView tvDescriptionDg,
      @NonNull TextView tvEanDg, @NonNull TextView tvNameDg, @NonNull TextView tvPriceDg,
      @NonNull TextView tvQuantityDg, @NonNull TextView tvShopDg, @NonNull TextView tvStockDg) {
    this.rootView = rootView;
    this.btnClose = btnClose;
    this.btnFavoriteDg = btnFavoriteDg;
    this.btnShoppingDg = btnShoppingDg;
    this.btnStockMinus = btnStockMinus;
    this.btnStockPlus = btnStockPlus;
  ...
  @NonNull
  public static DialogItemInfoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogItemInfoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_item_info, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogItemInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_stock_minus;
      ImageButton btnStockMinus = ViewBindings.findChildViewById(rootView, id);
      if (btnStockMinus == null) {
        break missingId;
      }

      id = R.id.btn_stock_plus;
      ImageButton btnStockPlus = ViewBindings.findChildViewById(rootView, id);
      if (btnStockPlus == null) {
        break missingId;
      }
      ...
      id = R.id.tv_stock_dg;
      TextView tvStockDg = ViewBindings.findChildViewById(rootView, id);
      if (tvStockDg == null) {
        break missingId;
      }

      return new DialogItemInfoBinding((LinearLayout) rootView, btnClose, btnFavoriteDg,
          btnShoppingDg, btnStockMinus, btnStockPlus, ivPicDg, textView6, tvDescriptionDg, tvEanDg,
          tvNameDg, tvPriceDg, tvQuantityDg, tvShopDg, tvStockDg);
    }
